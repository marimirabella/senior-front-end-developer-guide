...
This guide covers the main topics needed for an interview.
...
This project includes such features:
- server and client translations
- `MUI` library
- `themes` using MUI library
- `emotions/styled components` registries to use it with server side
- `next/mdx`
